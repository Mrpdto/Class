...
let lugulabre=new Pokemon('Boulbi',18,4,70,0.8);

while(dracofeu.hp >0 && lugulabre.hp>0){
    dracofeu.attackPokemon(lugulabre)
    if(lugulabre.hp<=0){
        console.log(lugulabre.name+" is dead !");
        break;
    }
    lugulabre.attackPokemon(dracofeu)
    if(dracofeu.hp<=0){
